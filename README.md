...
* Pré-seções:
  ...
  * Guia para configurações semanais: instruções para instalações de
  pacotes ou configurações que precisam ser feitas antes de cada sessão.
* Seções:
...
Esta sessão introduz técnicas de _Data Manging_ e como explorar padrões em dados antes de utilizar algoritmos.
